...
class BlockFrqAware(nn.Module):
    ...
    def __init__(self, dim: int, mlp_ratio: float = 4.0,
                 ...
                 use_l1_sparsity: bool = True, use_l2_sparsity: bool = True,
        ...
        if use_freq_compensatory_mlp:
            ...
            self.mlp = FreqCompMLP(
                ...
                use_compensate_gate=use_compensate_gate
            )
        else:
...
class SWformerFrequencyAware(nn.Module):
    ...
    def __init__(self, 
        ...
        self.config = {
            ...
            'use_l1_sparsity': use_l1_sparsity,
            'use_l2_sparsity': use_l2_sparsity,
            'use_compensate_gate': use_compensate_gate,
        }
